...
/** Pure composition helpers exposed only through the package's internal entry. */
export const runtimePartComposerInternals = {
  discardResolvedDeferredColliderWarnings,
  mountHeadOptionalPrefabGraphs,
  findHeadOptionalAttachTransform,
  retainHeadOptionalPrefabSubtree,
  isSameOrDescendantPath,
  applyAccessoryControllerTransform,
  unityQuaternionFromEulerDegrees,
  mergeRuntimeFUnitSummaries,
  mergeRuntimeRawSpringBone,
  resolveComposedBodyHeadAssembly,
  resolveComposedBodyAttachPath,
  resolveComposedHeadOriginPath,
  hasRuntimeSetupTransformPath,
  getPartRuntimeSetup,
  remapRuntimePart,
  selectRuntimePartActiveRoots,
  filterRuntimeRecordsByActiveRoots,
  remapRuntimeExtraBones,
  remapRuntimeObjectRef,
  filterColliderBindingsByActiveBones,
  filterManagerColliderCachesByActiveManagers,
  remapRuntimeConstraints,
  remapPrefabGraph,
  withInferredSpringManagerBoneRefs,
  isSameOrDescendantRuntimePath,
  cloneArrayWithPartPrefix,
  remapScalarFields,
  remapArrayFields,
  remapRuntimeForceProviders,
  remapNumericId,
  remapColliderRoots,
  synthesizeMissingColliderFlagBindings,
  rebuildColliderBindings,
  rebuildDeferredColliderFlagBinding,
  selectBodyCollidersForColliderFlag,
  matchesColliderFlagPrefix,
  rebuildBindingDecisions,
  rebuildManagerColliderCaches,
  rebuildHeadManagerColliderCache,
  filterManagerCache,
  collidersByRoot,
  hasColliderRoots,
  firstColliderRoot,
  ...
  mergeNativeMeshes,
  remapNativeMeshIds,
  resolveHeadOptionalFaceId,
  extractFaceIdFromBundlePath,
  resolveAccessoryTransformAdjustment,
  readAccessoryTransformAdjustments,
  readVectorLike,
  readNumber,
  normalizePathSegment,
  inheritMissingRoleEyeTextures,
  mergeMaterialSlots,
  resolveMaterialSlotTextureUrls,
  resolveMaybeUrl,
  resolveRequiredUrl,
  cloneRecord,
  isRecord,
