...
export const unityPrefabSpringRuntimeInternals = {
  buildRuntimeSpringComponentIndex,
  isOfficialRuntimeSpringComponent,
  isVerifiedRuntimeSpringBone,
  resolveColliderBinding,
  computeUnityPrefabChildPosition,
  collectUnityPrefabTailChildren,
  isValidPrefabSpringTailChild,
  buildPrefabGraphIndex,
  buildNodeResolution,
  resolveNode,
  resolveNodeForPart,
  resolvePrefabTransformForPart,
  partPathKey,
  readRuntimePartIndex,
  collectSkinnedBones,
  buildBoneMap,
  buildColliderBindingMap,
  buildBindingDecisionMap,
  buildManagerColliderCacheMap,
  isRuntimeManagerCacheCollider,
  buildActiveRootSet,
  isRuntimePathActive,
  resolveLengthLimitTargets,
  buildCandidateRootMap,
  filterCollidersByManagerCache,
  constrainColliderRootsByManagerCache,
  selectUnityColliderRoot,
  selectHeadColliderRoot,
  buildColliderBindingDiagnostic,
  cloneColliderBindingDiagnostic,
  preferMatchingPoseColliders,
  preferredColliderRoot,
  managerCacheSummary,
  ...
  normalizeRootName,
  vectorFromUnity,
  resolveRuntimeBoneAxis,
  normalizeRuntimeAxis,
  readRawNumber,
  readUnityRawVector,
  readRawBoolean,
  readRawObjectPathId,
  ...
  asRecord,
  getObjectPath,
  getCanonicalObjectPath,
  stripThreeUniqueNameSuffix,
  sourceColliderOrder,
  worldScaleX,
  matrixWorldXScale,
